...
def get_taxonomy_centrifuge(table, metadata, taxodir):
    ...
    all_taxonomy_columns = ['Virus GENBANK accession', 'Realm', 'Kingdom',
...
if snakemake.params.taxo_profiler == "centrifuge":
    ...
    tmp = get_taxonomy_centrifuge(
        ...
        # "/mnt/archgen/microbiome_coprolite/aVirus/03-data/refdbs/ICTV/centrifuge_only_ICTV/taxonomy"
    )
    ...
    tmp = get_taxonomy_kraken2(
        ...
        metadata,
        "/mnt/archgen/microbiome_coprolite/aVirus/03-data/refdbs/metabuli_db/taxonomy"
        # "/mnt/archgen/microbiome_coprolite/aVirus/03-data/refdbs/ICTV/kraken2_only_ICTV/taxonomy"
    )
    ...
    tmp = get_taxonomy_metabuli(
        ...
        metadata,
        "/mnt/archgen/microbiome_coprolite/aVirus/03-data/refdbs/metabuli_db/taxonomy"
        # "/mnt/archgen/microbiome_coprolite/aVirus/03-data/refdbs/ICTV/metabuli_only_ICTV/taxonomy"
    )
    ...
    tmp = get_taxonomy_krakenuniq(
        ...
        metadata,
        "/mnt/archgen/microbiome_coprolite/aVirus/03-data/refdbs/metabuli_db/taxonomy"
        # "/mnt/archgen/microbiome_coprolite/aVirus/03-data/refdbs/ICTV/krakenuniq_only_ICTV/taxonomy"
    )
